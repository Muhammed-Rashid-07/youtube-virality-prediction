...
from steps.model import train_model
...
def train_pipeline(epochs: int = 2, lr: float = 0.001, num_run: int = 1):
    ...
    random_forest = train_model("random_forest", X_train=X_train, y_train=y_train)
    ...
    ada_boost = train_model("ada_boost", X_train=X_train, y_train=y_train)
    ...
    gradient_boost = train_model("gradient_boost", X_train=X_train, y_train=y_train)
